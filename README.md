...
A clean and responsive music player built with **HTML**, **Tailwind CSS** and **JavaScript**. This player allows users to upload their own music files, automatically displays the song title, artist and shows the cover image embedded in the file using [jsmediatags](https://github.com/aadsm/jsmediatags).
